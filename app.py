        ...
        if is_ai is not None:
            ...
            if is_ai:
                ...
                <div class="result-box ai-result">
                    🔍 <b>Result:</b> This image appears to be <span style='color:#f44336'><b>AI-generated</b></span>
                </div>
                """, unsafe_allow_html=True)
            else:
                st.markdown(f"""
                <div class="result-box human-result">
                    🔍 <b>Result:</b> This image appears to be <span style='color:#4caf50'><b>human-made</b></span>
                </div>
                """, unsafe_allow_html=True)
